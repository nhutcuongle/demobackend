...
class CreateEventForUserScreen extends StatefulWidget {
  const CreateEventForUserScreen({super.key});

  @override
  State<CreateEventForUserScreen> createState() =>
      _CreateEventForUserScreenState();
}

class _CreateEventForUserScreenState extends State<CreateEventForUserScreen> {
  ...
  void initState() {
    super.initState();
    futureUsers = UserService.getAssignableUsers();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Tạo sự kiện cho user")),
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            ListTile(
              ...
              subtitle: Text(
                startTime == null ? "Chưa chọn" : _format.format(startTime!),
              ),
